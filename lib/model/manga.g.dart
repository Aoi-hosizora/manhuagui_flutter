...
Manga _$MangaFromJson(Map<String, dynamic> json) => Manga(
      ...
      perScores: (json['per_scores'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      downed: json['downed'] as bool,
      copyright: json['copyright'] as bool,
      violent: json['violent'] as bool,
      lawblocked: json['lawblocked'] as bool,
...
Map<String, dynamic> _$MangaToJson(Manga instance) => <String, dynamic>{
      ...
      'lawblocked': instance.lawblocked,
...
HomepageMangaGroupList _$HomepageMangaGroupListFromJson(
    ...
    HomepageMangaGroupList(
      ...
      daily: (json['daily'] as List<dynamic>)
          .map((e) => MangaRanking.fromJson(e as Map<String, dynamic>))
          .toList(),
      genres: (json['genres'] as List<dynamic>)
          .map((e) => Category.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$MangaRankingToJson(MangaRanking instance) =>
    <String, dynamic>{
      'mid': instance.mid,
      'title': instance.title,
      'cover': instance.cover,
