...
class DownloadDao {
  ...
  static const mangaMetadata = TableMetadata(
    ...
    columns: [_colDmMangaId, _colDmMangaTitle, _colDmMangaCover, _colDmMangaUrl, _colDmError, _colDmUpdatedAt],
  );
  ...
  static const chapterMetadata = TableMetadata(
    ...
    columns: [_colDcMangaId, _colDcChapterId, _colDcChapterTitle, _tblDcChapterGroup, _colDcTotalCount, _colDcTriedCount, _colDcSuccessCount],
  );
