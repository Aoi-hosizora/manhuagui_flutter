...
if [ -f deps/photo_view/lib/reloadable_photo_view.dart ]; then
  ...
  sed -i "0,/this.errorBuilder,/s//this.errorBuilder,\n    this.customBuilder,\n    this.onLoadingStateChanged,/" deps/photo_view/lib/reloadable_photo_view.dart
  sed -i "0,/final ErrorPlaceholderBuilder? errorBuilder;/s//final ErrorPlaceholderBuilder? errorBuilder;\n\n  final Widget Function(BuildContext, Widget)? customBuilder;\n\n  final void Function()? onLoadingStateChanged;/" deps/photo_view/lib/reloadable_photo_view.dart
  sed -i "s/errorBuilder: widget.errorBuilder,/errorBuilder: widget.errorBuilder,\n        customBuilder: widget.customBuilder,\n        onLoadingStateChanged: widget.onLoadingStateChanged,/" deps/photo_view/lib/reloadable_photo_view.dart
fi
